...
mod new {
    ...
    // #[test]
    // #[should_panic(expected="mismatched blossom sides")]
    // fn mismatched_sides() {
    //     Blossom::new(1, vec![ 2, 1, 0 ], vec![ 5, 4, 3, 2, 0 ]);
    // }
...
mod lift {
    ...
    #[test]
    #[should_panic(expected="path missing blossom id: 5")]
